    ...
    <div class="container">
        ...
        <div class="row">
        		<div class="box text-center">
                	<h2 class="brand-before">Willkommen bei</h2>
                    <h1 class="brand-name">Coffee Star</h1>
                    <h3 class="brand-before">Origins & Blends</h3>
                </div>
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <img class="img-responsive img-full" src="img/slide-12.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/slide-13.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/slide-14.jpg" alt="">
                            </div>
                        </div>
